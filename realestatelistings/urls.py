...
urlpatterns = [
    path("real-estate-listing/", views.ListRealEstateListingView.as_view()),
    ...
    path("extra-document/<int:pk>/delete/", views.ExtraDocumentDeleteView.as_view()),
    path("add-token-detail/", views.AddTokenDetail.as_view()),
    path("token-detail/<int:pk>/delete/", views.DeleteTokenDetail.as_view()),
    path("token-detail/<int:pk>/detail/", views.DetailTokenDetail.as_view()),
]
